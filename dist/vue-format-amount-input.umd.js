(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-format-amount-input"] = factory(require("vue"));
	else
		root["vue-format-amount-input"] = factory(root["Vue"]);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/@vue/cli-service/node_modules/vue-loader-v16/dist??ref--1-1!./src/components/VueFormatAmountInput.vue?vue&type=script&setup=true&lang=js
...
var _hoisted_1 = ["inputmode", "value", "placeholder", "disabled"];

/* Emmitters */

/* harmony default export */ var VueFormatAmountInputvue_type_script_setup_true_lang_js = ({
  props: {
    value: [String, Number],
    placeholder: String,
    options: Object
  },
  emits: ['input', 'keydown', 'blur', 'onEnter', 'pastedValueFallsOutOfMaxValue'],
  setup: function setup(__props, _ref) {
    ...
    *************************************************/
    ...
    var options = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["computed"])(function () {
      var _props$options, _props$options2;

      var merged = _objectSpread2(_objectSpread2(_objectSpread2({}, defaultOptions), props.options), {}, {
        maxValue: ((_props$options = props.options) === null || _props$options === void 0 ? void 0 : _props$options.maxValue) || defaultOptions.maxValue
      });

      if (!((_props$options2 = props.options) !== null && _props$options2 !== void 0 && _props$options2.decimalChar) && merged.digitGroupSeparator === '.') {
        merged.decimalChar = ',';
      }

      return merged;
    });
    var currencyLengthAtLeft = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["computed"])(function () {
    ...
    var currencyLengthAtRight = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["computed"])(function () {
    ...
    *************************************************/
    ...
    var isValidSeparator = function isValidSeparator(key) {
      return !!ALLOWED_DECIMAL_SEPARATORS.find(function (separator) {
        return separator === key;
      });
    };

    var isDigit = function isDigit(key) {
      return !!key.match(INTEGER_PATTERN);
    };

    var allowNegativeSign = function allowNegativeSign(value, index, key) {
    ...
    var addDecimalsToValue = function addDecimalsToValue(value) {
      if (!value) return '';

      var _value = value.includes(options.value.decimalChar) ? value : "".concat(value).concat(options.value.decimalChar);

      var currentDecimals = _value.split(options.value.decimalChar)[1].length;

      var decimalsToAdd = options.value.decimalsAllowed - currentDecimals;
    ...
    */
    ...
    var removeCurrencySymbol = function removeCurrencySymbol(value) {
      if (options.value.currencySymbol.length) {
        return value.replace(" ".concat(options.value.currencySymbol), '').replace("".concat(options.value.currencySymbol, " "), '');
      } else return value;
    };

    var parseMaxValue = function parseMaxValue(maxValue) {
      var toWorkMaxValue = options.value.maxValue;
      if (!ALLOWED_DECIMAL_SEPARATORS.find(function (separator) {
        return toWorkMaxValue.includes(separator);
      })) toWorkMaxValue = addDecimalsToValue(toWorkMaxValue);
      return toWorkMaxValue;
    };

    var validateIfAmountInsideMaxValueRange = function validateIfAmountInsideMaxValueRange(value) {
      var _value = removeCurrencySymbol(value);
      ...
      var toWorkMaxValue = parseMaxValue(options.value.maxValue);
    ...
    *************************************************/
    ...
    var ALLOWED_DECIMAL_SEPARATORS = [',', '.', '٫'];
    ...
    var getInitValue = function getInitValue() {
      ...
      if (props.value || props.value === 0) {
        parsedValue = props.value.toLocaleString('fullwide', {
          useGrouping: false
        });
        ALLOWED_DECIMAL_SEPARATORS.forEach(function (separator) {
          parsedValue = parsedValue.replaceAll(separator, options.value.decimalChar);
        });
      }
    ...
    var _value = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(getInitValue());

    var inputDomRef = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])('');
    var showCurrency = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(false);
    var disableInput = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(true);
    var inputOnFocus = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(false);
    var triggerFocusCaret = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(false);
    /* we could also use selectionStart, since both props are the same when writing */

    var currentCaretPositon = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(0);
    var valueHasNegativeChar = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(false);
    var replaceZerosLeft = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(false);
    /*************************************************
    *                                                *
    *                   WATCHERS                     *
    *                                                *
    *************************************************/
    ...
    Object(external_commonjs_vue_commonjs2_vue_root_Vue_["watch"])(function () {
      ...
      setTimeout(function () {
        return handleValueChange(inputDomRef.value, true);
      }, 0);
    });
    /* Watching if currency change, and reformat our value */

    Object(external_commonjs_vue_commonjs2_vue_root_Vue_["watch"])(function () {
      return options.value.currencySymbol;
    }, function (newVal, oldVal) {
    ...
    Object(external_commonjs_vue_commonjs2_vue_root_Vue_["watch"])(function () {
      return options.value.maxValue;
    }, function (newVal, oldVal) {
      if (props.value) {
        var parsedValue = props.value.toLocaleString('fullwide', {
          useGrouping: false
        });
        ALLOWED_DECIMAL_SEPARATORS.forEach(function (separator) {
          parsedValue = parsedValue.replaceAll(separator, options.value.decimalChar);
    ...
    */
    ...
    var keydownHandler = function keydownHandler($event) {
      ...
      if (($event.key === 'ArrowLeft' || $event.key === 'ArrowRight') && !$event.shiftKey) {
        var charToValidate = $event.key === 'ArrowLeft' ? elem.value.charAt(elem.selectionEnd - 2) : elem.value.charAt(elem.selectionEnd + 1);
      ...
      if ($event.key === '0' && elem.selectionEnd === currencyLengthAtLeft.value && removeCurrencySymbol(elem.value).length > 0) {
        $event.preventDefault();
        return;
      }
      ...
      if (isDigit($event.key) && elem.value.charAt(currencyLengthAtLeft.value) === '0' && elem.selectionEnd - 1 === currencyLengthAtLeft.value) {
      ...
      if (isDigit($event.key) && elem.value.charAt(currencyLengthAtLeft.value) === '0' && elem.selectionEnd !== currencyLengthAtLeft.value && elem.value.charAt(elem.selectionEnd) !== options.value.decimalChar) {
      ...
      if (isValidSeparator($event.key) && !elem.value.includes(options.value.decimalChar)) {
        ...
        if (elem.selectionEnd === elem.value.length - currencyLengthAtRight.value) {
          ...
          */
          var additionalValueBeforeDecimal = !removeCurrencySymbol(elem.value).length ? '0' : '';
      ...
      var valNoCurrency = options.value.currencySymbolPlacement === 's' ? removeCurrencySymbol(elem.value) : elem.value;
      /* Preventing user from writinig more than two decimals chars */

      if (isDigit($event.key) && checkDecimalCharsLength(valNoCurrency) >= options.value.decimalsAllowed && elem.selectionStart === elem.selectionEnd && elem.selectionEnd === valNoCurrency.length) {
        $event.preventDefault();
      }
      ...
      if (isDigit($event.key) && elem.selectionStart === elem.selectionEnd) {
        var newValue = elem.value.slice(0, elem.selectionStart) + $event.key + elem.value.slice(elem.selectionStart);
      ...
      */
      ...
      if (isDigit($event.key) && checkDecimalCharsLength(valNoCurrency) >= options.value.decimalsAllowed && elem.selectionEnd >= valNoCurrency.length - options.value.decimalsAllowed && elem.selectionEnd !== valNoCurrency.length && elem.selectionStart === elem.selectionEnd) {
        /*
    ...
    */
    ...
    var blurHandler = function blurHandler($event) {
      ...
      var valueWithoutCurrency = removeCurrencySymbol(_value.value);
      var rawValue = valueWithoutCurrency.replace('-', '');

      if (rawValue.length > 0 && options.value.alwaysAllowDecimalCharacter) {
        var currencyPrefix = options.value.currencySymbolPlacement === 'p';
        /* Creating a string with options.value.decimalsAllowed zeros */

        var decimalsNeeded = options.value.decimalsAllowed - checkDecimalCharsLength(rawValue);
        var decimals = Array.from({
          length: decimalsNeeded
        }, function (v, k) {
          return '0';
        }).join('');
        /* we should use raw value if we want to hide negative sign, no sense in showing -0.00 */

        var applyNegativeSymbol = parseFloat(unformat(rawValue)) > 0;
        var temp;

        if (_value.value.includes(options.value.decimalChar)) {
          temp = "".concat(applyNegativeSymbol ? valueWithoutCurrency : rawValue).concat(decimals);
        } else {
          temp = "".concat(applyNegativeSymbol ? valueWithoutCurrency : rawValue).concat(options.value.decimalChar).concat(decimals);
        }

        if (options.value.currencySymbol.length) {
          $event.target.value = currencyPrefix ? "".concat(options.value.currencySymbol, " ").concat(temp) : "".concat(temp, " ").concat(options.value.currencySymbol);
    ...
    var preventEmitInput = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(false);
    ...
    var setCurrencyShowValue = function setCurrencyShowValue(state, preventEmitInput) {
      ...
      if (valueWithoutCurrency.length <= 0) {
        ...
        setTimeout(function () {
          return handleValueChange(inputDomRef.value, true, preventEmitInput);
        }, 0);
      }
    };
    /*
    ...
    */
    ...
    var inputValueHandler = function inputValueHandler($event) {
      var elem = $event.target;
    ...
    */
    ...
    var handleValueChange = function handleValueChange(elem, insertedFromPaste, preventEmitInput, emitIfFallsOutOfMaxValue) {
      ...
      if (insertedFromPaste) {
        ...
        if (!validateIfAmountInsideMaxValueRange(elem.value) && emitIfFallsOutOfMaxValue) {
          ...
          console.warn("Value <".concat(elem.value, "> falls out of our maxValue <").concat(parseMaxValue(options.value.maxValue), ">"));
          elem.value = '';
        }
      }

      var decimals = checkDecimalCharsLength(elem.value);
      ...
      */
      ...
      if (removeCurrencySymbol(elem.value).length === 0 && triggerFocusCaret.value && options.value.currencySymbolPlacement === 's') {
    ...
    */
    ...
    var removingUnwantedChars = function removingUnwantedChars(value) {
      if (!value) return '';
    ...
    */
    ...
    var handlePasteValue = function handlePasteValue(pastedValue) {
      var value = removingUnwantedChars(pastedValue);
      ...
      */
      ...
      var separatorsInString = []; // { separator: count }

      ALLOWED_DECIMAL_SEPARATORS.forEach(function (separator) {
        if (!value.includes(separator)) return;
        var count = value.length - value.replaceAll(separator, '').length;
        separatorsInString.push({
          separator: separator,
          count: count
        });
      });
      ...
      */
      ...
      var separatorUsedOnce = separatorsInString.find(function (obj) {
        return obj.count === 1;
      });

      if (separatorsInString.length && !!separatorUsedOnce) {
        separatorsInString.filter(function (obj) {
          return obj.separator !== separatorUsedOnce.separator;
    ...
    var parseFloatAndFormat = function parseFloatAndFormat(value) {
      if (!options.value.alwaysAllowDecimalCharacter) return value;
      var splitedValue = value.split('.');
      var decimalNumber = splitedValue[1] ? Number("0.".concat(splitedValue[1])).toFixed(options.value.decimalsAllowed) : '';
      var wholeNumber = splitedValue[0].length && splitedValue[0] !== 0 ? Number(splitedValue[0]) : splitedValue[0];
      return "".concat(wholeNumber, ",").concat(decimalNumber.replace('0.', '')).replace('.', options.value.decimalChar);
    };
    /*
    ...
    */
    ...
    var unformat = function unformat(value) {
      var val = value.toString();
    ...
    var removeLeftZeros = function removeLeftZeros(value, decimals) {
      var charsToReplaceAtLeft = 0;

      for (var index = 0; index < value.length - (decimals + 1); index++) {
    ...
    */
    ...
    var format = function format(value, decimals) {
      var _value = value;
    ...
    */
    ...
    var applyingDecimals = function applyingDecimals(value, decimals, emitValue) {
      var _value = value;
      var decimalChar = emitValue ? '.' : options.value.decimalChar;
    ...
    */
    ...
    var applyingGroupSeparator = function applyingGroupSeparator(value, decimals) {
      var separators = 0;
      var _val = value.split(options.value.decimalChar)[0];

      var _decimals = decimals !== null ? "".concat(options.value.decimalChar).concat(value.split(options.value.decimalChar)[1]) : '';
      ...
      return "".concat(_val).concat(_decimals);
    };
    /*
    ...
    */
    ...
    var applyingNegativeSymbol = function applyingNegativeSymbol(value) {
    ...
    */
    ...
    var applyingCurrencySymbol = function applyingCurrencySymbol(value) {
      ...
      if (options.value.currencySymbolPlacement === 'p') {
        ...
        return "".concat(options.value.currencySymbol, " ").concat(value);
      } else {
        return "".concat(value, " ").concat(options.value.currencySymbol);
      }
    };
    /*
    ...
    */
    ...
    var changeCurrencySymbol = function changeCurrencySymbol(value, newCurrency, oldCurrency) {
      // If there's no old currency, we need to add the new one with a space
      if (!oldCurrency) {
        if (!newCurrency) return value;

        if (options.value.currencySymbolPlacement === 'p') {
          return "".concat(newCurrency, " ").concat(value);
        } else {
          return "".concat(value, " ").concat(newCurrency);
        }
    ...
    */
    ...
    var formatToOnlyAmount = function formatToOnlyAmount(value) {
      var decimals = checkDecimalCharsLength(value);
      var valueNumbered = unformat(value);
      if (!valueNumbered.length) return null;
      valueNumbered = applyingDecimals(valueNumbered, decimals, true);
      /* Adding negative sign */

      if (options.value.allowNegativeValues && valueHasNegativeChar.value) valueNumbered = "-".concat(valueNumbered);
      return valueNumbered;
    };
    /* Position input caret in specific position */


    var setCaretPosition = function setCaretPosition(elem, position) {
    ...
    */
    ...
    var stringReplaceAt = function stringReplaceAt(string, index, replacementValue) {
    ...
    var updateValue = function updateValue(value, preventEmitInput) {
      _value.value = value;
    ...
    Object(external_commonjs_vue_commonjs2_vue_root_Vue_["onMounted"])(function () {
      ...
      if (props.value || props.value === 0) {
        ...
        if (!validateIfAmountInsideMaxValueRange(parsedValue)) {
          console.warn("Value <".concat(parsedValue, "> falls out of our maxValue <").concat(parseMaxValue(options.value.maxValue), ">"));
        }
      }
    ...
    return function (_ctx, _cache) {
      return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["openBlock"])(), Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createElementBlock"])("input", {
        ...
        ref_key: "inputDomRef",
        ref: inputDomRef,
        inputmode: Object(external_commonjs_vue_commonjs2_vue_root_Vue_["unref"])(options).isIOS ? 'decimal' : 'numeric',
        value: _value.value,
        ...
        onBlur: blurHandler,
        onKeyup: _cache[0] || (_cache[0] = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["withKeys"])(function ($event) {
          return emit('onEnter');
        }, ["enter"])),
...
// CONCATENATED MODULE: ./src/components/VueFormatAmountInput.vue?vue&type=script&setup=true&lang=js
 
// CONCATENATED MODULE: ./src/components/VueFormatAmountInput.vue



const __exports__ = VueFormatAmountInputvue_type_script_setup_true_lang_js;

/* harmony default export */ var VueFormatAmountInput = (__exports__);
...
//# sourceMappingURL=vue-format-amount-input.umd.js.map